...
const componentLibraries = [
  ...
  { name: "8bitcn", url: "https://www.8bitcn.com/", description: "UI component library" },
  { name: "Aevr UI", url: "https://ui.aevr.space/", description: "UI component library" },
  { name: "BaseCN", url: "https://basecn.dev/", description: "shadcn/ui component library" },
  { name: "DiceUI", url: "https://www.diceui.com/", description: "UI component library" },
  { name: "Elements", url: "https://www.tryelements.dev/", description: "UI component library" },
  { name: "FormCN", url: "https://formcn.dev/", description: "Form components for shadcn/ui" },
  { name: "HexTA UI", url: "https://hextaui.com/", description: "UI component library" },
  { name: "Intent UI", url: "https://intentui.com/", description: "UI component library" },
  { name: "Kokonut UI", url: "https://kokonutui.com/", description: "UI component library" },
  { name: "Kanpeki", url: "https://kanpeki.vercel.app/", description: "UI component library" },
  { name: "Cult UI", url: "https://www.cult-ui.com/", description: "UI component library" },
  { name: "Eldora UI", url: "https://eldoraui.site/", description: "UI component library" },
  { name: "HA Components", url: "https://hacomponents.keshuac.com/", description: "UI component library" },
  { name: "Lens Blocks", url: "https://lensblocks.com/", description: "UI component blocks" },
  { name: "Limeplay", url: "https://limeplay.winoffrg.dev/", description: "UI component library" },
  { name: "Systaliko UI", url: "https://systaliko-ui.vercel.app/", description: "UI component library" },
  { name: "ROI UI", url: "https://roiui.com/", description: "UI component library" },
  { name: "Solace UI", url: "https://www.solaceui.com/", description: "UI component library" },
  { name: "Shadcn Blocks", url: "https://shadcnblocks.com/", description: "shadcn/ui component blocks" },
  { name: "Shadcn Design", url: "https://www.shadcndesign.com/", description: "shadcn/ui components and templates" },
  { name: "Shadcn Studio", url: "https://shadcnstudio.com/", description: "shadcn/ui component studio" },
  { name: "Shadcn Editor", url: "https://shadcn-editor.vercel.app/", description: "Editor components for shadcn/ui" },
  { name: "ShadcnUI Blocks", url: "https://shadcnui-blocks.com/", description: "shadcn/ui component blocks" },
  { name: "Spectrum UI", url: "https://ui.spectrumhq.in/", description: "UI component library" },
  { name: "Tailark", url: "https://tailark.com/", description: "UI component library" },
  { name: "Taki UI", url: "https://taki-ui.com/", description: "UI component library" },
  { name: "UtilCN", url: "https://utilcn.dev/", description: "Utility components for shadcn/ui" },
  { name: "Wandry UI", url: "https://ui.wandry.com.ua/", description: "UI component library" },
  { name: "Wigggle UI", url: "https://wigggle-ui.vercel.app/", description: "UI component library" },
  { name: "ZippyStarter", url: "https://zippystarter.com/", description: "UI component starter templates" }
];
